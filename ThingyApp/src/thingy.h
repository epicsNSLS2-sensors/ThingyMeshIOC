...
#define RESPONSE_SERVICE 2
#define RESPONSE_TEMPERATURE_VAL 3
#define RESPONSE_TEMPERATURE_REM 4
#define RESPONSE_HUMIDITY 5
#define RESPONSE_PRESSURE_B1 6
#define RESPONSE_PRESSURE_B2 7
#define RESPONSE_PRESSURE_B3 8
#define RESPONSE_PRESSURE_B4 9
